...
using Mes.Shopfloor.Edge.SharedKernel.Infrastructure.Persistence.EntityFrameworkCore;
...
{
    public static IServiceCollection AddMesShopfloorEdgeSharedKernel(this IServiceCollection services, IConfiguration configuration, Assembly[] assemblies)
    {
        // Logging
        ...
        // Core persistence
        services.AddDbContext<DbContext, ShopfloorEdgeDbContext>();
